...
/* copy data from the cache block blk to the buffer p or the other way around depends on the cmd */
...
/* update the presentFlag */
void update_present_flag(struct cache_t *cp, /* cache to access */
                         enum mem_cmd cmd,   /* access type, Read or Write */
                         md_addr_t addr,     /* address of access */
                         int nbytes)         /* number of bytes to access */
{
